...
typedef enum icp201xx_meas_mode {
	ICP201XX_MEAS_MODE_FORCED_TRIGGER =
		0, /* Force trigger mode based on icp201xx_forced_meas_trigger_t **/
	ICP201XX_MEAS_MODE_CONTINUOUS =
		1 /* Continuous measurements based on selected mode ODR settings*/
