...
#include "imu/inv_imu_edmp_lowg_memmap.h"

int icm566xx_edmp_get_lowg_parameters(inv_imu_device_t *s, inv_imu_edmp_apex_parameters_lowg_t *p)
{
...
int icm566xx_edmp_set_lowg_parameters(inv_imu_device_t *s, const inv_imu_edmp_apex_parameters_lowg_t *p)
{
	int             status = INV_IMU_OK;
